...
Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    if user.deactivated_at?
      redirect_to root_path, notice: 'Your account is deactivated.'
    end

    unless user.oauth_applications.exists?(uid: request.env['action_dispatch.request.parameters']['client_id'])
